...
given_when_actions = ['visiting site', 'filling input', 'clicking button', 'clicking link']
then_actions = ['assert url of site', 'assert title of site']
...
def create_step():
    ...
    while True:
        ...
        if event == sg.WIN_CLOSED or event == "Exit":
            ...
            delete_action_button.call(window, todo_actions)
            ...
            print(actions)
            window['-ACTIONS-CHOICE-'].update(values=actions, value=actions[0])
